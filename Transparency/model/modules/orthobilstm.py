...
class OrthoBiLSTM(nn.Module):

    """A module that runs multiple steps of OrthoBiLSTM."""

    def __init__(self, cell_class, input_size, hidden_size, num_layers=1,
                 use_bias=True, batch_first=False, dropout=0, **kwargs):
        super(OrthoBiLSTM, self).__init__()
    ...
    def forward(self, input_, length=None, hx=None):
        ...
        for layer in range(self.num_layers):
            ...
            if layer == 0:
                layer_output_forward, layer_cell_output_forward, (layer_h_n_forward, layer_c_n_forward) = OrthoBiLSTM._forward_rnn(
